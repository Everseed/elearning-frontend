...
import { Course, Page, Post } from "@ng-youth/lib/models";
import { buildQueryParams } from "@ng-youth/lib/utils";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="flex flex-col justify-center mb-5 lg:mb-0">
              ...
              <div className="text-primary-foreground/75 dark:text-foreground/75 mb-6">
                Hi, Welcome to NgYouth. Start a new career in the software
                developing industry.
              </div>
              <div className="mb-4">
                <Button
